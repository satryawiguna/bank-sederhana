                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="panel">
                                <!-- Validation Errors -->
{{--                                <x-withdraw.validation-errors class="mb-4" :errors="$errors" />--}}

                                @if (\Session::has('success'))
                                    <x-withdraw.success class="mb-4" :success="\Session::get('success')" />
                                @endif
                                <div class="title">
                                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Form Withdraw</h2>
                                </div>
                                <div class="x_content">
